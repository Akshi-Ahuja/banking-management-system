...
function DepositPage() {
  ...
  return (
    <>
      ...
      <PageHeader
        eyebrow="Transactions / Deposit"
        title="Deposit Money"
        description="Add funds to a customer account."
      />
        ...
        <section className="panel form-panel">
          ...
          <div className="form-heading">
            ...
            <div>
              ...
              <p>
                Enter account and deposit information.
              </p>
            </div>
          ...
          >
            ...
            <div className="rule-note">
              ...
              <div>
                ...
                <p>
                  The account must be active and the amount must be greater than zero.
                </p>
